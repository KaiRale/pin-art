<?php
namespace Kairale\PinArtStudio\Core;
...
class Router
{
    ...
    public static function run(){
        ...
        $controller= 'Kairale\PinArtStudio\Controllers\\' . ucfirst(strtolower($controller)).'Controller'; // формируем имя класса контроллера
